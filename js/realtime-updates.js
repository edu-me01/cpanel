...
class RealtimeUpdates {
    ...
    updateAttendanceStatus(isOpen) {
        ...
        if (typeof studentDashboard !== 'undefined' && studentDashboard.loadAttendanceData) {
    ...
    updateSession(session) {
        ...
        const studentSessionSelect = document.getElementById('studentAttendanceSession');
    ...
    updateAttendanceRecords() {
        ...
        if (typeof studentDashboard !== 'undefined' && studentDashboard.loadAttendanceHistory) {
    ...
    triggerUpdate(type, data) {
        switch (type) {
            case 'attendance':
                localStorage.setItem('attendanceOpen', data.isOpen.toString());
                localStorage.setItem('currentSession', data.session || 'morning');
                break;
        }
    }
}
