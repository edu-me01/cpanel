...
class TaskManager {
  ...
  loadRecentActivity() {
    ...
    const activities = [
      {
        type: "task",
        message: 'New task "React Fundamentals" assigned',
        time: "2 minutes ago",
      },
      {
        type: "attendance",
      ...
      {
        type: "submission",
        message: "Assignment submitted by Jane Smith",
        time: "10 minutes ago",
      },
      {
        type: "student",
        message: "New student registered: Mike Johnson",
        time: "15 minutes ago",
      },
    ];
  ...
  loadSavedSettings() {
    const settings = {
      theme: session.getItem("theme") || "dark",
      language: session.getItem("language") || "en",
      dateFormat: session.getItem("dateFormat") || "MM/DD/YYYY",
      timeFormat: session.getItem("timeFormat") || "12h",
      notifications: session.getItem("notifications") === "true",
    };
