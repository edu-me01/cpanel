...
class SubmissionsManager {
    ...
    init() {
        ...
        // Add event listeners
        document.getElementById('gradeSubmissionForm').addEventListener('submit', (e) => this.handleGradeSubmission(e));
    ...
    handleFilter(filter) {
        ...
        switch (filter) {
            ...
            case 'graded':
                ...
                break;
            case 'late':
                filteredSubmissions = this.submissions.filter(s => s.status === 'late');
                break;
        }
