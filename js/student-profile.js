...
class StudentProfile {
    ...
    loadTaskProgress() {
        ...
        enabledTasks.forEach(task => {
            ...
            tr.innerHTML = `
                ...
                <td>
                    <button class="btn btn-sm btn-primary" onclick="studentProfile.viewTask('${task.day}')">
                        <i class="fas fa-eye"></i>
                    </button>
                    <button class="btn btn-sm btn-success" onclick="studentProfile.submitTask('${task.day}')">
    ...
    loadRecentSubmissions() {
        ...
        submissions.forEach(submission => {
            ...
            tr.innerHTML = `
                ...
                <td>
                    <span class="badge bg-${this.getSubmissionStatusColor(submission.status)}">
                        ${submission.status}
                    </span>
                </td>
    ...
    updateProgressBars() {
        // Calculate progress
        const enabledTasks = taskConfig.getEnabledTasks();
        const completedTasks = enabledTasks.filter(task => this.isTaskCompleted(task.day)).length;
        ...
        document.getElementById('tasksProgress').textContent = `${Math.round(tasksProgress)}%`;
